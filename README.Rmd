...
-   `item_index`: A more in-depth set of metadata about items in the Pokémon games, such as item name, cost, category, and attributes, the power and effect of the move "Fling" when used with this item, and the Pokémon that can hold it.
