...
### Example 1
Below is a demonstration of a potential use for the item index table. We have used a simple data visualization to analyze a potential relationship between an item's fling power and its cost and faceted it by category, for those categories of items that include values for both cost and fling power.
